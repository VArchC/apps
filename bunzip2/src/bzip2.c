...
void compress ( Char *name )
{
   ...
   /* FGG forces writing to a local temp file */
   strcpy(outName, "bzip2.tmp");
   forceOverwrite=True;
...
void uncompress ( Char *name )
{
   ...
   /**
    * Approximated Region (only for decompress)
    */
   //vac_newSection();
...
#  endif
    ...
    * Forcing flags 
    */
   opMode = OM_UNZ; //OPERATION MODE = BUNZIP
   srcMode == SM_I2O; //READING FILE FROM STDIN
